...
const MapSection = () => {
    return (
        <section className="bg-[#F2F2F2] pt-10 pb-32 px-12 lg:px-24 rounded-t-[2.5rem] lg:rounded-t-[3rem] relative z-20">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
                ...
                <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl group border border-black/5 bg-gray-200">
                    <iframe 
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="pt-6">
                        <button className="bg-black text-white h-[54px] px-10 rounded-2xl font-bold text-[12px] tracking-[0.2em] uppercase flex items-center gap-4 transition-all duration-500 hover:bg-[#22C55E] hover:scale-105 active:scale-95 group">
